...
/// tests : 1271974
/// testsPerOneMillion : 31211
/// population : 40754388
/// continent : "Asia"
/// oneCasePerPeople : 183
/// oneDeathPerPeople : 5143
/// oneTestPerPeople : 32
/// activePerOneMillion : 307.4
/// recoveredPerOneMillion : 4970.51
/// criticalPerOneMillion : 1.1

class StatsCountryModel {
  StatsCountryModel({
      num? updated, 
      String? country, 
  ...
  StatsCountryModel.fromJson(dynamic json) {
...
StatsCountryModel copyWith({  num? updated,
  String? country,
  CountryInfo? countryInfo,
  num? cases,
  num? todayCases,
  ...
  num? recoveredPerOneMillion,
  num? criticalPerOneMillion,
}) => StatsCountryModel(  updated: updated ?? _updated,
